#' @export
testPhenotypeStrata <- function(phenotype,
                                runDateTime,
                                connectionDetails,
                                cutPoints = c("EV"),
                                outFolder,
  ...
  if (strataValue == "Male") {
    ...
    if (is.null(evaluationCohort$prediction)) {
      print(paste("No prediction rows", databaseId, phenotype, strataValue, sep = ", "))
    ...
    analysisName <- strataValue
  }

  if (strataValue == "Female") {
  ...
  # male * age strata tests ====================================================

  if (strataValue == "Male <5") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear < 5 & gender == 8507)
  ...
  if (strataValue == "Male 5 - 17") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 5 & ageYear <= 17 & gender == 8507)
  ...
  if (strataValue == "Male 18 - 34") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 18 & ageYear <= 34 & gender == 8507)
  ...
  if (strataValue == "Male 35 - 54") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 35 & ageYear <= 54 & gender == 8507)
  ...
  if (strataValue == "Male 55 - 64") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 55 & ageYear <= 64 & gender == 8507)
    if (is.null(evaluationCohort$prediction)) {
      print(paste("No prediction rows", databaseId, phenotype, strataValue, sep = ", "))
      return(tibble::tibble(
        phenotype = phenotype,
  ...
  if (strataValue == "Male 65 - 74") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 65 & ageYear <= 74 & gender == 8507)
  ...
  if (strataValue == "Male 75 - 84") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 75 & ageYear <= 84 & gender == 8507)
  ...
  if (strataValue == "Male >=85") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 85 & gender == 8507)
  ...
  # female * age strata test ===================================================

  if (strataValue == "Female <5") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear < 5 & gender == 8532)
  ...
  if (strataValue == "Female 5 - 17") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 5 & ageYear <= 17 & gender == 8532)
  ...
  if (strataValue == "Female 18 - 34") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 18 & ageYear <= 34 & gender == 8532)
  ...
  if (strataValue == "Female 35 - 54") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 35 & ageYear <= 54 & gender == 8532)
  ...
  if (strataValue == "Female 55 - 64") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 55 & ageYear <= 64 & gender == 8532)
    if (is.null(evaluationCohort$prediction)) {
      print(paste("No prediction rows", databaseId, phenotype, strataValue, sep = ", "))
      return(tibble::tibble(
        phenotype = phenotype,
  ...
  if (strataValue == "Female 65 - 74") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 65 & ageYear <= 74 & gender == 8532)
  ...
  if (strataValue == "Female 75 - 84") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 75 & ageYear <= 84 & gender == 8532)
  ...
  if (strataValue == "Female >=85") {

    evaluationCohort$prediction <- evaluationCohort$prediction %>%
      dplyr::filter(ageYear >= 85 & gender == 8532)
  ...
  if (!is.null(evaluationCohort$errorMessage)) {
    ...
    sql <- paste0(
      "SELECT DISTINCT subject_id, cohort_start_date AS pheno_cohort_start_date
